...
namespace CustomerLogin.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            // RoleManager<IdentityRole> _roleManager; -- make the property and insert it to constructor
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // set the Customer role for the created user
                    await _userManager.AddToRoleAsync(user, "Customer"); // (await _userManager.FindByNameAsync(user.UserName), "Customer");
